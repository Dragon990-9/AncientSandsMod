...
{
	public class BluesteelRevolver : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Bluesteel Revolver");
			Tooltip.SetDefault("Has an odd green reflectiveness");
		}
		...
		public override void SetDefaults() {
			...
			item.value = 30234; // how much the item sells for (measured in copper)
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ModContent.ItemType<Items.Materials.BluesteelBar>(), 10);
			recipe.AddIngredient(ModContent.ItemType<Weapons.AncientRevolver>(), 1);
