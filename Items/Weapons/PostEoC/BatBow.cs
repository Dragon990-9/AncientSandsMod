...
namespace AncientSandsMod.Items.Weapons.PostEoC
{
	public class BatBow : ModItem
	{
		public override void SetStaticDefaults()
		{
			...
			Tooltip.SetDefault("Fires a bat fang");
		}
		...
		public override void SetDefaults()
		{
			...
			item.height = 46; // hitbox height of the item
							  // The item's use time in ticks (60 ticks == 1 second.)
							  // The length of the item's use animation in ticks (60 ticks == 1 second.)
			...
			item.value = 20864; // how much the item sells for (measured in copper)
		...
		public override bool Shoot(Player player, ref Vector2 position, ref float speedX, ref float speedY, ref int type, ref int damage, ref float knockBack)
		{
			...
			{
				type = ModContent.ProjectileType<Projectiles.PostEoC.BatFang>(); // or ProjectileID.FireArrow;
			}
