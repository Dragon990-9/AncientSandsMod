...
{
	public class AncientRevolver : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("Ancient Revolver");
			Tooltip.SetDefault("A very old revolver, made of a strong metal");
		}
		...
		public override void SetDefaults() {
			...
			item.value = 20234; // how much the item sells for (measured in copper)
