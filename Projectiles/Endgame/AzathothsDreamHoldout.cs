using AncientSandsMod.Items.Weapons.Endgame;
...
{
	public class AzathothsDreamHoldout : ModProjectile
	{
		...
		private void FireBeams()
		{
			...
			{
				Projectile.NewProjectile(projectile.Center, beamVelocity, ModContent.ProjectileType<AzathothsDreamBeam>(), damage, knockback, projectile.owner, b, uuid);
			}
		...
		public override bool PreDraw(SpriteBatch spriteBatch, Color lightColor)
		{
			...
			Color drawColor = AzathothsDream.OverrideColor;
